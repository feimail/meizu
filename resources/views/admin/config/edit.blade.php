                    		...
                    		<div class="mws-form-inline">
                    			<div class="mws-form-row">
                    				...
                    				<div class="mws-form-item">
                    					<input class="small" name='title' type="text" value="{{$row->title}}">
                    				</div>
                    			</div>
                                <div class="mws-form-row">
                                    <label class="mws-form-label">网站版权</label>
                                    <div class="mws-form-item">
                                        <input class="small" name='copyright' type="text" value="{{ $row->copyright}}">
                                    </div>
                                </div>
                                <div class="mws-form-row">
                                    <label class="mws-form-label">注册号</label>
                                    <div class="mws-form-item">
                                        <input class="small" name='registerid' type="text"value="{{ $row->registerid}}">
                                    </div>
                                </div>
                                <div class="mws-form-row">
                                    <label class="mws-form-label">经营许可证</label>
                                    <div class="mws-form-item">
                                        <input class="small" name='allow' type="text"value="{{ $row->allow}}">
                                    </div>
                                </div>
                                <div class="mws-form-row">
                                    <label class="mws-form-label">ICP备案号</label>
                                    <div class="mws-form-item">
                                        <input class="small" name='number' type="text"value="{{ $row->number}}">
                                    </div>
                                </div>
                                ...
                                <div class="mws-form-row">
                                  ...
                                  <div class="mws-form-item" style="width:400px">
                                    <img src="{{$row->headlogo}}" width="100px" >
                                 ...
                                 <div class="mws-form-row">
                                    ...
                                    <div class="mws-form-item">
                                        <textarea rows="" cols="" class="small" name="description">{{ $row->description}}</textarea>
                                    </div>
                                </div>
                                <div class="mws-form-row">
