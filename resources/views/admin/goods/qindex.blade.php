...
@section('content')
  ...
  <div class="mws-panel-header">
    <span>
      <i class="icon-table"></i>商品答疑列表</span>
  </div>
  <div class="mws-panel-body no-padding">
    <div id="DataTables_Table_1_wrapper" class="dataTables_wrapper" role="grid">
    
    <form action="/admin/goods/qindex" method="get">
      ...
      <table class="mws-datatable-fn mws-table dataTable" id="DataTables_Table_1" aria-describedby="DataTables_Table_1_info">
        <thead>
          <tr role="row">
            ...
            <th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1" rowspan="1" colspan="1" aria-label="Browser: activate to sort column ascending" style="width: 208px;">商品ID</th>
            ...
            <th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1" rowspan="1" colspan="1" aria-label="CSS grade: activate to sort column ascending" style="width: 101px;">用户名</th>
            <th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1" rowspan="1" colspan="1" aria-label="CSS grade: activate to sort column ascending" style="width: 101px;">咨询问题</th>
            <th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1" rowspan="1" colspan="1" aria-label="Platform(s): activate to sort column ascending" style="width: 194px;">客服回答</th>
            <th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1" rowspan="1" colspan="1" aria-label="Engine version: activate to sort column ascending" style="width: 136px;">状态</th>
        ...
        @foreach($row as $k=>$v)
          <tr class="<?php echo $k%2==0?'even':'odd' ?>">
            ...
            <td class=" ">{{$v->answer}}</td>
            <td class=" ">
              <input cid="{{$v->id}}" class="ibutton" type="checkbox" @if($v->status) checked="checked" @endif>
              </td>
            <td class=" "><a href="/admin/goods/qedit?id={{$v->id}}" style="color:black"><button class="btn btn-success btn-small" type="button">答复</button></a><a href="/admin/goods/qdelete?id={{$v->id}}" style="color:black"><button class="btn btn-danger btn-small" type="button">删除</button></a></td>
            </tr>
         @endforeach
        </tbody>
      </table>
...
@section('js')
  ...
  <!-- JavaScript Plugins -->
    ...
    $('.ibutton-container').click(function(){
      ...
      //发送
      $.get('/admin/goods/quesajax-update', {status: status, id: id}, function(data){
          if(data == '1'){
            alert('状态更新成功');
          }else{
            alert('状态更新失败');
