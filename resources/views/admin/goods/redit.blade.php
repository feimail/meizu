...
@section('xiugai')
  <li> <a href="#"><i class="icon-calculate"></i>商品详情信息</a> 
       <ul class=""> 
...
<div class="mws-panel grid_8">
  ...
  <div class="mws-panel-body no-padding">
	...
	@if (count($errors) > 0)
		...
		@endif
       <form class="mws-form" action="/admin/goods/rupdate" method="post" enctype="multipart/form-data" >
      <div class="mws-form-inline">
        ...
        <div class="mws-form-row">
          ...
          <div class="mws-form-item">
            <input type="text" class="small"  name="goodsid" value="{{$row->id}}" disabled="disabled"></div>
        </div>
         <div class="mws-form-row">
          <label class="mws-form-label">商品颜色:</label>
          <div class="mws-form-item">
            <input type="text" class="small"  name="color" value="{{$rows->color}}"></div>
        </div>
  
            <input type="hidden" class="small"  name="goodsid" value="{{$row->id}}">
             <input type="hidden" class="small"  name="id" value="{{$rows->id}}">
        <div class="mws-form-row">
