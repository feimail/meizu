      ...
      <table class="mws-datatable-fn mws-table dataTable" id="DataTables_Table_1" aria-describedby="DataTables_Table_1_info">
        <thead>
          <tr role="row">
            ...
            <th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1" rowspan="1" colspan="1" style="width: 239px;" aria-label="Browser: activate to sort column ascending">网站名称</th>
            <th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1" rowspan="1" colspan="1" style="width: 239px;" aria-label="Browser: activate to sort column ascending">网站地址</th>
            <th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1" rowspan="1" colspan="1" style="width: 239px;" aria-label="Browser: activate to sort column ascending">网站描述</th>
            <th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="Platform(s): activate to sort column ascending" style="width: 209px;">时间</th>
        ...
        @foreach($row as $k => $v)
          ...
          ">
            ...
            <td class=" "><a href="/admin/you/edit?id={{$v->id}}" ><button type="button" class="btn btn-primary btn-small"style="float:left;font-size:9px;">修改</button></a><a href="/admin/you/delete?id={{$v->id}}" ><button type="button" class="btn btn-danger btn-small"style="font-size:9px;">删除</button></a></td>
          </tr>
		@endforeach
        </tbody>
      </table>
...
@section('js')
  ...
  <!-- JavaScript Plugins -->
    ...
    $('.ibutton-container').click(function(){
      ...
      //发送
      $.get('/admin/you/ajaxupdate', {status: status, id: id}, function(data){
          if(data == '1'){
            alert('更新成功');
          }else{
            alert('更新失败');
