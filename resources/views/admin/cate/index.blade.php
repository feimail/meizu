      ...
      <table class="mws-datatable-fn mws-table dataTable" id="DataTables_Table_1" aria-describedby="DataTables_Table_1_info">
        <thead>
          <tr role="row">
            ...
            <th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1" rowspan="1" colspan="1" style="width: 239px;" aria-label="Browser: activate to sort column ascending">分类名称</th>
            <th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1" rowspan="1" colspan="1" style="width: 225px;" aria-label="Platform(s): activate to sort column ascending">父级分类</th>
            <th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1" rowspan="1" colspan="1" style="width: 225px;" aria-label="Platform(s): activate to sort column ascending">路径</th>
            ...
            <th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1" rowspan="1" colspan="1" style="width: 95px;" aria-label="CSS grade: activate to sort column ascending">操作</th></tr>
        </thead>
        ...
        @foreach($row as $k => $v)
          ...
          ">
            ...
            <td class=" "><a href="/admin/cate/edit?id={{$v->id}}" ><button type="button" class="btn btn-primary btn-small"style="float:left;font-size:9px;">修改</button></a><a href="/admin/cate/delete?id={{$v->id}}" ><button type="button" class="btn btn-danger btn-small"style="font-size:9px;">删除</button></a></td>
          </tr>
        @endforeach
        </tbody>
      </table>
