...
<div class=ucSimpleHeader id="header">
	...
	<div id="trigger">
		...
		@endif
		 ...
		 @if(session('error'))
            ...
            @endif
			<form id="register-form" name="register-form" action="/index/youxiang" method="post">
				<div class="number">
					<!-- <a class="linkAGray" id="toTelRegister" href="/go//register">账户注册</a> -->
					<!-- <span class="register-line"></span> -->
					<a class="linkABlue" id="toNameR egister" href>邮件已发送,请到邮箱查看</a>
				</div>
	...
	<center>
	<table style="border:0px solid ; width:800px;  ">
					<tr>
						<th>邮箱</th>
						<th>链接</th>
					</tr>
					...
					<tr>
						<th>新浪</th>
						<th><a href="http://mail.sina.com.cn/">http://mail.sina.com.cn/</a></th>
					</tr>
					<tr>
						<th></th>
						<th></th>
					...
					<tr>
						<th>QQ</th>
						<th><a href="https://mail.qq.com/">https://mail.qq.com/</a></th>
					</tr>
					<tr>
						<th></th>
						<th></th>
					...
					<tr>
						<th>163</th>
						<th><a href="http://mail.163.com/">http://mail.163.com/</a></th>
					</tr>
				</table>
	</center>
