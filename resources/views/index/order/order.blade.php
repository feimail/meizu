...
<div class="site-topbar clearfix">
    <div class="mzcontainer">
        ...
        <a href="" target="_blank" data-mtype="store_index_yt_6" data-mdesc="页头中第6个">社区</a>
        </div>
        <div class="topbar-right">
            <ul class="topbar-info">
                ...
                <li>
                    <a class="topbar-link" href="" target="_blank">我的收藏<div class="topbar-new">new</div></a>
                </li>
                ...
                <li class="mz_login" style="display: none;">
                    <a class="topbar-link" href="r" target="_blank">注册</a>
                </li>
                <li class="topbar-info-member" style="">
                    ...
                    <div class="site-member-items">
                        <a class="site-member-link" href=" /index/address?id={{session('uid')}}" target="_blank" data-mtype="store_index_yt_9_2" data-mdesc="我的商城下拉框2">地址管理</a>
            ...
            <div class="topbar-info-pop"><div id="MzMsgPop"><a class="title" href="" target="_blank" data-mtype="store_index_yt_qp" data-mdesc="气泡">912魅友节，全场五折起</a><div class="triangle"></div><div class="close"></div></div></div>
        </div>
    </div>
</div>
        ...
        <ul class="order-address-list clearfix" id="biankuang">
          <li class="order-address-checkbox ">
            <div class="order-address-checkbox-top">
              ...
              <div class="order-address-checkbox-phone">{{$v->phone}}</div></div>
            ...
            <div class="kai"  >
                ...
                <div class="order-address-form open" id="addressForm">
                    ...
                    <div class="order-address-row clearfix">
                        ...
                        <input type="text" class="order-address-input" name="dtaddress" placeholder="请输入详细地址" maxlength="50" id="addressFormDetail"></div>
                        <div class="order-address-row-tips"></div>
                    </div>
                    <div class="order-address-row clearfix">
                        <div class="order-address-row-title"></div>
          ...
          <table cellspacing="0" cellpadding="0">
            <thead>
              <tr>
                ...
                <th class="order-product-table-express">运费</th></tr>
            </thead>
