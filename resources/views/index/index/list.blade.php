    ...
    <main class="wrapper" id="main">
        <div class="container">
                                ...
                                <dl class="gl-item-wrap">
                                    <dd class="mod-pic">
                                        <a data-mtype="store_list_kw_1" target="_blank" href="/index/detail?id={{$v->id}}" title="">
                                            <img width="220" height="220" src="{{$v->img}}">
                                        </a>
                                    </dd>
                                    <dd class="mod-name">
                                        <a data-mtype="store_list_kw_1" target="_blank" href="/index/detail?id={{$v->id}}" title=""> {{$v->goodsname}} </a>
                                    </dd>
                                    <dd class="mod-price">
                                        <em>￥</em>
                                        <i>
            ...
            <section class="pages" id="pages">
                <div class="paginate"> {!!$res->appends($request)->render()!!}</div>
            </section>
            <section class="recommend" id="recommend">
                ...
                <div class="recommend-slider" id="J_recommendSlider">
                    <ul class="recommend-slider-wrap">
                        @foreach($res1 as $k=>$v)
                            <li class="rs-item">
                                <a class="rs-item-wrap" data-mtype="sotre_list_tj_1" href="/index/detail?id={{$v->id}}">
                                    <div class="mod-pic">
