...
<div class="store-wrap">
    ...
    <div class="left-nav f-fl">
        <div class="nav-main">
            ...
            <a href="http://me.meizu.com/member/favorite/index" class="ml active">我的收藏</a>
        ...
        <div class="right-content f-fr">
            <div class="collect-main">
                <div class="type-tab-btn">
                    <a href="javascript:;" class="active allOrder">已收藏商品</a></i>
                </div>
...
<script type="text/javascript" src="/go/gos/js/jquery-1.8.3.min.js">
