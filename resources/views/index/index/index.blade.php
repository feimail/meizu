                                ...
                                <div class="nav-children-wrap">
                                   ...
                                   @for($i = 0;$i<ceil(count($v->arr)/2);$i++)         
                                        <li class="nav-children-item">
                                            <a href="/index/detail?id={{ $v->arr[$i]->id}}" target="_blank" data-mtype="store_index_cdh_2_1" data-mdesc="侧边导航中第2个分类第1个产品">
                                    ...
                                    @if(isset($v->brr))                           
                                        <a href="/index/detail?id={{ $v->brr->id}}" target="_blank" data-mtype="store_index_cdh_2_gg" data-mdesc="侧边导航中第2个分类广告">
                    ...
                    <a href="/index/detail?id={{$v->id}}" target="_blank"
                       ...
                       data-mdesc="热品推荐第1屏第1个坑">
                        <div class="rmd-product-detail">
                            <img src="{{ $v->img}}" alt="魅族 MX6" width="180"
                                 height="180"/>
                ...
                <div class="home-panel-topbar">
                    ...
                    <h6 class="home-panel-subtitle">
                            ...
                            <div class="home-panel-tools home-floor-tools">
                                <a class="home-tool-more" href="/index/list?pid={{$v->id}}" target="_blank"
