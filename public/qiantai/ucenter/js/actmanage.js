...
//                 },
    ...
    getKapkey: function() {
        ...
        $("form").delegate(".get_kapkey", "click", function(e) {
            ...
            var vCodeType = 12;
            var param = {};
            var sendEmailVcode = "/uc/webjsp/vcode/sendEmailVcode?targetId=" + targetId;
    ...
    saveEvent: function(json, index) {
        ...
        $(json.save).click(function() {
            if ($(this).attr("id") == "ce-u-activenext") { //修改邮箱第一步   ReceiveEmail会动态改变，写到点击事件内部,避免被缓存
                var validEmailCodeUrl = "/uc/webjsp/vcode/isValidEmailVCode?email=" + ReceiveEmail + "&vCodeTypeValue=12";
